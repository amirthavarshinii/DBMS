---
title: "Practicum 2"
author: "Kaushik Holla and Spatika Krishnan"
date: "4/19/2021"
output: pdf_document
---

### The practicum is submitted by Kaushik Holla and Spatika krishnan
...
#knitr::include_graphics("C://Users/spati/OneDrive/Documents/practicum 2/part1.png")
knitr::include_graphics("D://Northeastern\ University//CS5200\ DBMS//Practicum/Practicum\ 2/part1.jpeg")
...
```{sql connection=dbcon}
select * from history_star limit 10;
```
```{r}
...
```{sql connection=dbcon}
select * from pubmed_article_star limit 5;
```
...
select * from author_dimensional ;
...
select * from history_dimensional ;
...
select * from journal_dimensional ;
...
select * from article_dimensional ;
