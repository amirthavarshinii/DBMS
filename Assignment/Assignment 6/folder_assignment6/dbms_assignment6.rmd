...
### Please note that the data already exists in table so please refer to the screenshot in pdf file to see the working.
### Incase you want to see the working please drop course table and AuditCourse table and run everything from beginning. The code for dropping the table are in comments at the end of this file.
...
#### Code for droppong the table
#```{sql connection=dbcon}
#DROP table AuditCourse;
#```
